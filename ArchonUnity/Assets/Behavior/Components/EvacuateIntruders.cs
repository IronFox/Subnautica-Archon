...
namespace Assets.Behavior.Components
{
    [RequireComponent(typeof(Collider))]
    [DisallowMultipleComponent]
    [AddComponentMenu("Behavior/Components/EvacuateIntruders")]
    /// <summary>
    /// Component that uses local sphere colliders to push out any objects that should not be inside the parent object,
    /// and pull back in any objects that should be inside the parent object.
    /// </summary>
